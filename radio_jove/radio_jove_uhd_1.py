...
class radio_jove_uhd_1(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Radio Jove UHD, v1")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Radio Jove UHD, v1")
        ...
        self.settings = Qt.QSettings("GNU Radio", "radio_jove_uhd_1")
        ...
        self.main_tab_grid_layout_0.addWidget(self._fosphor_qt_sink_c_0_0_win, 1, 4, 4, 4)
        for r in range(1, 5):
            self.main_tab_grid_layout_0.setRowStretch(r, 1)
        for c in range(4, 8):
            self.main_tab_grid_layout_0.setColumnStretch(c, 1)
        ...
        self.main_tab_grid_layout_0.addWidget(self._fosphor_qt_sink_c_0_win, 1, 0, 4, 4)
        for r in range(1, 5):
            self.main_tab_grid_layout_0.setRowStretch(r, 1)
        for c in range(0, 4):
            self.main_tab_grid_layout_0.setColumnStretch(c, 1)
...
def main(top_block_cls=radio_jove_uhd_1, options=None):
