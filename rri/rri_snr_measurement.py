...
class rri_snr_measurement(gr.top_block, Qt.QWidget):

    def __init__(self, avg_len=1024, decim=16, lpf_bw=1.5e3, nfft=2048):
        gr.top_block.__init__(self, "RRI SNR Measurement")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("RRI SNR Measurement")
        ...
        self.settings = Qt.QSettings("GNU Radio", "rri_snr_measurement")
...
def main(top_block_cls=rri_snr_measurement, options=None):
    if options is None:
